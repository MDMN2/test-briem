...
const devs = ['350135013465128966'];
const db = require('quick.db');
const premium = ['350135013465128966']
...
${prefix}inv/لدعوة البوت الى سيرفرك
 سيرفر الدعم https://discord.gg/f436jRW
**
  `
,`
...
client.users.get("350135013465128966").send(
    "\n" + "**" + "? السيرفر :" + "**" +
    "\n" + "**" + "» " + message.guild.name + "**" +
    "\n" + "**" + " ? المرسل : " + "**" +
    "\n" + "**" + "» " + message.author.tag + "**" +
...
client.channels.get("350135013465128966").sendEmbed(embed)
});
...
if (message.content.startsWith('G.users')){
 if(!message.author.id === '350135013465128966') return;
...
if (message.author.id !== '350135013465128966') return message.reply('** هذا الأمر فقط لصاحب البوت و شكراًً **')
client.user.setGame(argresult);
